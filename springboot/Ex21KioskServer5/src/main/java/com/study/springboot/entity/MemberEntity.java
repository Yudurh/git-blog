...
public class MemberEntity {
    ...
    public static MemberEntity toMemberEntity(MemberDto dto1){
        return MemberEntity.builder()
                .memberNo(dto1.getMemberNo())
                .memberId(dto1.getMemberId())
                .memberPw(dto1.getMemberPw())
                .memberName(dto1.getMemberName())
                .memberRole(dto1.getMemberRole())
                .memberPoint(dto1.getMemberPoint())
                .memberJoinDatetime(dto1.getMemberJoinDatetime())
                .build();
