...
//    @GetMapping("/itemlist-drink")
    ...
    @PostMapping("/upP1")
    public ResultDto upP1(@RequestBody MemberDto memberDto,
                       Model model){

        MemberEntity newEntity = null;
        MemberEntity entity = MemberEntity.toMemberEntity(memberDto);
        newEntity = memberRepository.save(entity);
    ...
    @ResponseBody
    public String delete(@RequestParam(required = false, defaultValue = "0") long memberNo,
...
//        memberList.remove( index );
    ...
    @PostMapping("/update_p1")
    public ResultDto update_p1(@RequestBody ItemDto itemDto,
                          Model model){

        ItemEntity entity1 = ItemEntity.toEntity(itemDto);
        ItemEntity newEntity = itemRepository.save(entity1);
    ...
    @PostMapping("/update_o1")
    public ResultDto update_o1(@RequestBody OrderDto orderDto,
                               Model model){

       OrderEntity entity1 = OrderEntity.toEntity(orderDto);
        OrderEntity newEntity = orderRepository.save(entity1);
