...
CREATE TABLE cart (
   ...
   item_code VARCHAR(255) NOT NULL , -- 상품 코드(UUID포맷-32자리)
    ...
    option_name_1 VARCHAR(255) DEFAULT ('해당없음'),
	 option_name_2 VARCHAR(255) DEFAULT ('해당없음'),
	 option_name_3 VARCHAR(255) DEFAULT ('해당없음'), -- 옵션이름
...
CREATE TABLE `order` (
    ...
    order_code VARCHAR(255) NOT NULL UNIQUE, -- 주문코드(UUID포맷-32자리)
      -- 구매상품 정보
    cart_item_code_1 VARCHAR(255) NOT NULL , -- 상품코드1(UUID포맷-32자리)
    cart_item_code_2 VARCHAR(255) , -- 상품코드2(UUID포맷-32자리)
    cart_item_code_3 VARCHAR(255) , -- 상품코드3(UUID포맷-32자리)
    cart_item_code_4 VARCHAR(255) , -- 상품코드4(UUID포맷-32자리)
    cart_item_code_5 VARCHAR(255) , -- 상품코드5(UUID포맷-32자리)
    ...
    -- 결제방법
    order_pay_type VARCHAR(255) NOT NULL, -- 01 신용카드 또는 02 간편결제
    -- 주문상태
