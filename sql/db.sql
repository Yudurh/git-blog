...
INSERT INTO item VALUES(NULL, '456e4567-e89b-12d3-a456-556642440005', '해피밀 햄버거™', apporder
...
INSERT INTO item VALUES(NULL, '456e4567-e89b-12d3-a456-556642440011', '코카-콜라', 
        '음료', 0, 2400, 'https://www.mcdonalds.co.kr/upload/product/pcList/1583889953745.png', DEFAULT);
...
INSERT INTO `order` VALUES(NULL,'123e4567-e89b-12d3-a456-556642441234', '123e4567-e89b-12d3-a456-556642440000',null,null,null,NULL, '35000',1,123, DEFAULT,'결제완료',DEFAULT);
SELECT * FROM `order`
-- 영수증 정보
DROP TABLE if EXISTS receipt;
CREATE TABLE receipt (
    receipt_no INT AUTO_INCREMENT PRIMARY KEY, -- 고유키
    receipt_number INT NOT NULL , -- 영수증 번호
    receipt_machine_no INT NOT NULL , -- 키오스크 기기 번호(01,02...)
    ...
    receipt_datetime DATETIME DEFAULT NOW() -- 결제 시간kioskkiosk
);
